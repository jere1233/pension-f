...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  void _calculate() {
    ...
    // ✅ FIX: use double literals in clamp so result is double, not num
    final gap = (requiredNest - projected).clamp(0.0, double.infinity);
                            ...
                            children: [
                              Expanded(
                                child: _OutlookTile(
                                  ...
                                  progressValue:
                                      replacementRatio.clamp(0.0, 100.0),
...
class _InputFieldState extends State<_InputField> {
  ...
  void initState() {
    ...
    _controller = TextEditingController(
      text: widget.value.toStringAsFixed(widget.step < 1 ? 1 : 0),
    );
  }
  ...
  void didUpdateWidget(_InputField oldWidget) {
    ...
    if (oldWidget.value != widget.value) {
      _sliderValue = widget.value;
      _controller.text =
          widget.value.toStringAsFixed(widget.step < 1 ? 1 : 0);
    }
  }
          ...
          child: Slider(
            ...
            onChanged: (v) {
              ...
              setState(() {
                ...
                _controller.text =
                    rounded.toStringAsFixed(widget.step < 1 ? 1 : 0);
              });
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(subtitle,
              style: TextStyle(
                  fontSize: 9.sp, color: Colors.white.withOpacity(0.75)),
              maxLines: 1,
              overflow: TextOverflow.ellipsis),
        ],
      ),
